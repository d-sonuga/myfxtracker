...
class InitDataTests(TestCase):
    def setUp(self) -> None:
        ...
        self.trader = Trader.objects.create_trader(**SignUpDetails.good_details)
        self.affiliate_token = Token.objects.create(user=self.affiliate)
    ...
    def test_init_data_valid_token_no_referred_users(self):
        ...
        """
        resp = self.make_request(self.affiliate_token)
