...
const HttpConst = {
    ...
    AFF_CHANGE_BANK_ACCOUNT_NAME_URL: 'aff/change-bank-account-name',
    AFF_CHANGE_BANK_NAME_URL: 'aff/change-bank-name',
...
const RouteConst = {
    ...
    ARCHIVE_INFO_ROUTE: 'archive-info/',
    /** 
...
const ConfigConst = {
    ...
    IS_ARCHIVE: process.env.REACT_APP_IS_ARCHIVE === "true"
}
