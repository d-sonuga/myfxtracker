...
describe('Verify accountReturnsGraphCalc is working', function () {
    ...
    describe('When accountData.trades isn\'t empty', function () {
        ...
        describe('When the a trade is taken today, this week, this month, ' +
            ...
            var result = (0, account_returns_graph_calc_1.default)(dummyAccountData, today);
            var defaultCalc = [{ tradeNo: 0, result: 0 }];
            var expectedTodayCalc = __spreadArray(__spreadArray([], defaultCalc, true), [{ tradeNo: 1, result: trades[4].profitLoss }], false);
            var expectedThisWeekCalc = __spreadArray(__spreadArray([], defaultCalc, true), [{ tradeNo: 1, result: trades[3].profitLoss },
                { tradeNo: 2, result: trades[3].profitLoss + trades[4].profitLoss }], false);
            var expectedThisMonthCalc = __spreadArray(__spreadArray([], defaultCalc, true), [{ tradeNo: 1, result: trades[2].profitLoss },
                { tradeNo: 2, result: trades[2].profitLoss + trades[3].profitLoss },
                { tradeNo: 3, result: trades[2].profitLoss + trades[3].profitLoss + trades[4].profitLoss }], false);
            var expectedThisYearCalc = __spreadArray(__spreadArray([], defaultCalc, true), [{ tradeNo: 1, result: trades[1].profitLoss },
                ...
                { tradeNo: 4, result: trades[1].profitLoss + trades[2].profitLoss + trades[3].profitLoss
                        + trades[4].profitLoss },], false);
            var expectedAllTimeCalc = __spreadArray(__spreadArray([], defaultCalc, true), [{ tradeNo: 1, result: trades[0].profitLoss },
                ...
                { tradeNo: 5, result: trades[0].profitLoss + trades[1].profitLoss + trades[2].profitLoss
                        + trades[3].profitLoss + trades[4].profitLoss }], false);
            var expectedResult = {
